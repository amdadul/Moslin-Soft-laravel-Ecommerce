...
<!-- Mirrored from demo.smartaddons.com/templates/html/topdeal/home3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Feb 2019 18:41:07 GMT -->
...
<head>
		...
		<!-- Libs CSS
				 ============================================ -->
		<link rel="stylesheet" href="{{asset('ClientAssets/css/bootstrap/css/bootstrap.min.css')}}">
		<link href="{{asset('ClientAssets/css/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet">
		<link href="{{asset('ClientAssets/js/datetimepicker/bootstrap-datetimepicker.min.css')}}" rel="stylesheet">
		<link href="{{asset('ClientAssets/js/owl-carousel/owl.carousel.css')}}" rel="stylesheet">
		<link href="{{asset('ClientAssets/css/themecss/lib.css')}}" rel="stylesheet">
		<link href="{{asset('ClientAssets/js/jquery-ui/jquery-ui.min.css')}}" rel="stylesheet">
		<link href="{{asset('ClientAssets/js/minicolors/miniColors.css')}}" rel="stylesheet">
		<link href="{{asset('ClientAssets/js/slick-slider/slick.css')}}" rel="stylesheet">
		<!-- Theme CSS
				 ============================================ -->
		<link href="{{asset('ClientAssets/css/themecss/so_searchpro.css')}}" rel="stylesheet">
		<link href="{{asset('ClientAssets/css/themecss/so_megamenu.css')}}" rel="stylesheet">
		<link href="{{asset('ClientAssets/css/themecss/so-listing-tabs.css')}}" rel="stylesheet">
		<link href="{{asset('ClientAssets/css/themecss/so-newletter-popup.css')}}" rel="stylesheet">
		<link href="{{asset('ClientAssets/css/footer/footer3.css')}}" rel="stylesheet">
		<link href="{{asset('ClientAssets/css/header/header3.css')}}" rel="stylesheet">
		<link id="color_scheme" href="{{asset('ClientAssets/css/home3.css')}}" rel="stylesheet">
		<link href="{{asset('ClientAssets/css/responsive.css')}}" rel="stylesheet">
		<link href="{{asset('ClientAssets/css/quickview/quickview.css')}}" rel="stylesheet">
		<!-- Google web fonts
				 ============================================ -->
																				...
																				<div class="html ">
																					<div class="col-lg-4 col-md-4 col-sm-12" style="text-align: center; margin-bottom: 20px;min-height: 140px;">
																						<a href="index.html" title="" style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
																							<img src="{{URL::to('ClientAssets/image/catalog/demo/menu/feature/layout1.jpg')}}" alt="layout" style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
																							<p>Home Page 1</p>
																						</a>
																					</div>
																					<div class="col-lg-4 col-md-4 col-sm-12" style="text-align: center; margin-bottom: 20px;min-height: 140px;">
																						<a href="home2.html" title="" style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
																							<img src="{{URL::to('ClientAssets/image/catalog/demo/menu/feature/layout2.jpg')}}" alt="layout" style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
																							<p>Home Page 2 </p>
																						</a>
																					</div>
																					<div class="col-lg-4 col-md-4 col-sm-12" style="text-align: center; margin-bottom: 20px;min-height: 140px;">
																						<a href="home3.html" title="" style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
																							<img src="{{URL::to('ClientAssets/image/catalog/demo/menu/feature/layout3.jpg')}}" alt="layout" style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
																							<p>Home Page 3 </p>
																						</a>
																					</div>
																					<div class="col-lg-4 col-md-4 col-sm-12" style="text-align: center; margin-bottom: 20px;min-height: 140px;">
																						<a href="home4.html" title="" style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
																							<img src="{{URL::to('ClientAssets/image/catalog/demo/menu/feature/layout4.jpg')}}" alt="layout" style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
																							<p>Home Page 4 </p>
																						</a>
																					</div>
																					<div class="col-lg-4 col-md-4 col-sm-12" style="text-align: center; margin-bottom: 20px;min-height: 140px;">
																						<a href="home5.html" title="" style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
																							<img src="{{URL::to('ClientAssets/image/catalog/demo/menu/feature/layout5.jpg')}}" alt="layout" style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
																							<p>Home Page 5 </p>
																						</a>
																					</div>
																					<div class="col-lg-4 col-md-4 col-sm-12" style="text-align: center; margin-bottom: 20px;min-height: 140px;">
																						<a href="home6.html" title="" style="font-size: 12px;text-transform: uppercase;font-weight: bold;text-align: center;">
																							<img src="{{URL::to('ClientAssets/image/catalog/demo/menu/feature/layout6.jpg')}}" alt="layout" style="margin: 0 0 10px; border: 1px solid #ddd;display: inline-block">
																							<p>Home Page 6 </p>
																						</a>
																					</div>
																				</div>
																...
																<div class="sub-menu" style="width: 100%">
																	<div class="content">
																		<div class="row">
																			<div class="col-sm-3">
																				<div class="link ">
																					<img src="{{URL::to('ClientAssets/image/catalog/demo/menu/menu-img1.jpg')}}" alt="" style="width: 100%;">
																				</div>
																			</div>
																			<div class="col-sm-3">
																				<div class="link ">
																					<img src="{{URL::to('ClientAssets/image/catalog/demo/menu/menu-img2.jpg')}}" alt="" style="width: 100%;">
																				</div>
																			</div>
																			<div class="col-sm-3">
																				<div class="link ">
																					<img src="{{URL::to('ClientAssets/image/catalog/demo/menu/menu-img3.jpg')}}" alt="" style="width: 100%;">
																				</div>
																			</div>
																			<div class="col-sm-3">
																				<div class="link ">
																					<img src="{{URL::to('ClientAssets/image/catalog/demo/menu/menu-img4.jpg')}}" alt="" style="width: 100%;">
																				</div>
																			</div>
																		</div>
																								...
																								<ul>
																									<li>
																										...
																										<ul>
																											...
																											<li><a href="#" onclick="window.location = '#';">Pearl Jewelry</a></li>
																											<li><a href="#" onclick="window.location = 'h.html#';">Spa &amp; Massage</a></li>
																										</ul>
																									</li>
																								</ul>
																							</div>
																							...
																							<div class="menu">
																								<ul>
																									...
																									<li>
																										<a href="#" onclick="window.location = '#';" class="main-menu">Food &amp; Restaurant</a>
																										<ul>
																											<li><a href="h.html#" onclick="window.location = '#';">Fashion</a></li>
																											<li><a href="#" onclick="window.location = '#';">Bags</a></li>
					...
					<div class="row">
						...
						<div class="header-search col-lg-6 col-md-6 col-sm-5 col-xs-7">
							<div id="sosearchpro" class="sosearchpro-wrapper so-search ">
								<form method="GET" action="https://demo.smartaddons.com/templates/html/topdeal/index.php">
																											...
																											<ul>
																												<li>
																													...
																													<ul>
																														...
																														<li><a href="#" onclick="window.location = '#';">Pearl mens</a></li>
																														<li><a href="#" onclick="window.location = '#';">Digital &amp; Electronics</a></li>
																														<li><a href="h.html#" onclick="window.location = '#';">Book Stationery</a></li>
																														<li><a href="#" onclick="window.location = '#';">Bluetooth Speakers</a></li>
																														<li><a href="#" onclick="window.location = '#';">Cell &amp; Cable</a></li>
																													</ul>
																												</li>
																											...
																											<ul>
																												<li>
																													...
																													<ul>
																														<li><a href="#" onclick="window.location = '#';">Pearl mens</a></li>
																														<li><a href="#" onclick="window.location = '#';">Girls New</a></li>
																														<li><a href="#" onclick="window.location = 'h.html#';">Pearl Jewelry</a></li>
																														<li><a href="#" onclick="window.location = '#';">Spa &amp; Massage</a></li>
																														<li><a href="#" onclick="window.location = '#';">Digital &amp; Electronics</a></li>
																														<li><a href="#" onclick="window.location = '#';">Camera New</a></li>
																														<li><a href="#" onclick="window.location = '#';">Bags</a></li>
																...
																<div class="product-item-container">
																	<div class="left-block ">
																		<div class="product-image-container so-quickview">
																			...
																			<img src="{{URL::to('ClientAssets/image/catalog/demo/product/fashion/5-60x60.png')}}" alt="Pariatur beef desktop publishing packages monst">
																			</a>
																		</div>
																		<div class="box-label">
																		</div>
...
<!-- //Laravel Container -->
								...
								<div class="col-lg-2 col-md-4 col-sm-4 col-xs-12 col_xi8a  col-style">
									<div class="footer-links">
										...
										<ul class="links">
											...
											<li>
												<a href="wishlist-2.html"> Wishlist</a>
											</li>
											<li>
												<a title="Order History" href="order-information-2.html">Order History</a>
											</li>
											<li>
	...
	<script type="text/javascript" src="{{asset('ClientAssets/js/jquery-2.2.4.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/bootstrap.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/themejs/so_megamenu.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/owl-carousel/owl.carousel.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/slick-slider/slick.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/themejs/libs.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/unveil/jquery.unveil.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/countdown/jquery.countdown.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/dcjqaccordion/jquery.dcjqaccordion.2.8.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/datetimepicker/moment.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/datetimepicker/bootstrap-datetimepicker.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/jquery-ui/jquery-ui.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/modernizr/modernizr-2.6.2.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/minicolors/jquery.miniColors.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/jquery.nav.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/quickview/jquery.magnific-popup.min.js')}}"></script>
	<!-- Theme files
			 ============================================ -->
	<script type="text/javascript" src="{{asset('ClientAssets/js/themejs/application.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/themejs/homepage.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/themejs/custom_h3.js')}}"></script>
	<script type="text/javascript" src="{{asset('ClientAssets/js/themejs/addtocart.js')}}"></script>
</body>


<!-- Mirrored from demo.smartaddons.com/templates/html/topdeal/home3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Feb 2019 18:41:16 GMT -->
</html>